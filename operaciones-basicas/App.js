...
<TouchableOpacity 
 style={{height: 60,backgroundColor:'green', marginTop:10,alignContent:'center',alignItems:'center',textAlignVertical:'center'}}
    onPress={() => {
 this.Restar(this.state.text1,this.state.text2);
}}
>
<Text style={{color:'white',fontSize:24,textAlignVertical:'center',textAlign: "center"}}>Restar</Text>
</TouchableOpacity>

<TouchableOpacity 
 style={{height: 60,backgroundColor:'red', marginTop:10,alignContent:'center',alignItems:'center',textAlignVertical:'center'}}
    onPress={() => {
 this.Multiplicar(this.state.text1,this.state.text2);
}}
>
<Text style={{color:'white',fontSize:24,textAlignVertical:'center',textAlign: "center"}}>Multiplicar</Text>
</TouchableOpacity>

<TouchableOpacity 
 style={{height: 60,backgroundColor:'black', marginTop:10,alignContent:'center',alignItems:'center',textAlignVertical:'center'}}
    onPress={() => {
 this.Dividir(this.state.text1,this.state.text2);
}}
>
<Text style={{color:'white',fontSize:24,textAlignVertical:'center',textAlign: "center"}}>Dividir</Text>
</TouchableOpacity>
